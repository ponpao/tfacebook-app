...
export function ModalShell({
  ...
  return (
    ...
    >
      <div
        className={`flex h-full max-h-[85vh] w-full ${width} flex-col overflow-hidden rounded border border-slate-400 border-t-4 border-t-indigo-600 bg-[#f0f2f5] shadow-2xl`}
      >
        <div
